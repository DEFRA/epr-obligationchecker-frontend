namespace FrontendObligationChecker.UnitTests.Services.PublicRegister
{
    ...
    public class BlobStorageServiceTests
    {
        ...
        [DataRow("ProducerContainer")]
        [DataRow("ComplianceSchemeContainer")]
        public async Task GetLatestFilePropertiesAllFoldersAsync_DoesNotReturnNull(string containerName)
        {
            _blobServiceClientMock.Setup(x => x.GetBlobContainerClient(It.IsAny<string>()))
                .Returns((BlobContainerClient)null);

            var result = await _service.GetLatestFilePropertiesAllFoldersAsync(containerName);
        ...
        [DataRow("ProducerContainer")]
        [DataRow("ComplianceSchemeContainer")]
        public async Task GetLatestFilePropertiesAllFoldersAsync_ReturnsOnlyPublicRegisterBlobModelWithPublishedDate_WhenContainerClientIsNull(string containerName)
        {
            _blobServiceClientMock.Setup(x => x.GetBlobContainerClient(It.IsAny<string>()))
                .Returns((BlobContainerClient)null);

            var result = (await _service.GetLatestFilePropertiesAllFoldersAsync(containerName)).Values.First();
        ...
        [DataRow("ProducerContainer")]
        [DataRow("ComplianceSchemeContainer")]
        public async Task GetLatestFilePropertiesAllFoldersAsync_ReturnsOnlyPublicRegisterBlobModelWithPublishedDate_WhenNoBlobsFound(string containerName)
        {
            var mockBlobContainerClient = new Mock<BlobContainerClient>();
        ...
        [DataRow("ProducerContainer", "")]
        [DataRow("ComplianceSchemeContainer", ".CSV")]
        public async Task GetLatestFilePropertiesAllFoldersAsync_ReturnsSuccess_WhenBlobsFoundWithBlobClientProperties(string containerName, string fileType)
        {
            var mockResponse = new Mock<Response<BlobProperties>>();
        ...
        [DataRow("ProducerContainer")]
        [DataRow("ComplianceSchemeContainer")]
        public async Task GetLatestFilePropertiesAllFoldersAsync_ThrowRequestFailedException_WhenFailsGetBlobs(string containerName)
        {
            var mockBlobContainerClient = new Mock<BlobContainerClient>();
            ...
            var act = async () => await _service.GetLatestFilePropertiesAllFoldersAsync(containerName);
        ...
        [DataRow("ProducerContainer")]
        [DataRow("ComplianceSchemeContainer")]
        public async Task GetLatestFilePropertiesAllFoldersAsync_ThrowRequestFailedException_WhenFailsGetBlobClient(string containerName)
        {
            var blobProperties = BlobsModelFactory.BlobProperties(lastModified: DateTimeOffset.UtcNow, contentLength: 1024);
            var blobList = new List<BlobItem>
                {
